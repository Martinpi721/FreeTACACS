...
TAC_PLUS_ACCT_STATUS = {
    'TAC_PLUS_ACCT_STATUS_SUCCESS': TAC_PLUS_ACCT_STATUS_SUCCESS,
    'TAC_PLUS_ACCT_STATUS_ERROR': TAC_PLUS_ACCT_STATUS_ERROR,
    'TAC_PLUS_ACCT_STATUS_FOLLOW': TAC_PLUS_ACCT_STATUS_FOLLOW,
}

# CHAP challenge response lengths
CHAP_CHALLENGE_RESPONSE_LENGTH = 16
MSCHAP_CHALLENGE_RESPONSE_LENGTH = 49
